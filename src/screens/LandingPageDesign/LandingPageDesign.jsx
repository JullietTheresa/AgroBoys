      ...
      <div className="div-2">
        ...
        <div className="seleao-de-plantas">
          <div className="frame-2">
            <div className="text-wrapper-10">Seleção de plantas</div>
          </div>
          <div className="text-wrapper-24">Ver Mais</div>
            ...
            <div className="group">
              <div className="overlap-group-3">
                <img
                  ...
                  alt="Rectangle"
                  src="https://c.animaapp.com/ZUyH8RTL/img/rectangle-7-2@2x.png"
                />
            ...
            <div className="group">
              <div className="overlap-group-3">
                <img
                  className="rectangle-4"
                  alt="Rectangle"
                  src="https://c.animaapp.com/ZUyH8RTL/img/rectangle-38-2@2x.png"
                />
            ...
            <div className="group">
              <div className="overlap-group-3">
                <img
                  className="rectangle-4"
                  alt="Rectangle"
                  src="https://c.animaapp.com/ZUyH8RTL/img/rectangle-41-2@2x.png"
                />
            ...
            <div className="overlap-wrapper">
              <div className="overlap-group-3">
                <img
                  className="rectangle-4"
                  alt="Rectangle"
                  src="https://c.animaapp.com/ZUyH8RTL/img/rectangle-42-2@2x.png"
                />
