          ...
          <div className="overlap-3">
              ...
              <div className="overlap-4">
                ...
                <div className="group-5">
                  <div className="overlap-group-2">
                    ...
                    <div className="text-wrapper-26">Não colhido</div>
                  </div>
                </div>
                <div className="text-wrapper-27">10/09/2024</div>
              </div>
            </div>
            <div className="text-wrapper-28">Cultura</div>
            ...
            <div className="group-6">
              <div className="overlap-5">
                <div className="text-wrapper-38">Colhido</div>
              </div>
            </div>
          </div>
        </div>
